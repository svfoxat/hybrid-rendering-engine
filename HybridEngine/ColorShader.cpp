...
bool ColorShader::Initialize(OpenGLRenderer* OpenGL, HWND hwnd) {
	bool result;


	// Initialize the vertex and pixel shaders.
	result = initShader("./color.vs", "./color.ps", OpenGL, hwnd);
	if (!result)
	{
		return false;
	}
...
void ColorShader::Shutdown(OpenGLRenderer* OpenGL) {
	ShutdownShader(OpenGL);
}

void ColorShader::setShader(OpenGLRenderer* OpenGL) {
	OpenGL->glUseProgram(m_shaderProgram);
}

bool ColorShader::initShader(const char* vsFilename, const char* fsFilename, OpenGLRenderer* OpenGL, HWND hwnd) {
...
void ColorShader::OutputShaderErrorMessage(OpenGLRenderer* OpenGL, HWND hwnd, unsigned int shaderId, const char* shaderFilename)
{
	int logSize, i;
	char* infoLog;
	ofstream fout;
...
void ColorShader::OutputLinkerErrorMessage(OpenGLRenderer* OpenGL, HWND hwnd, unsigned int programId)
{
	int logSize, i;
	char* infoLog;
	ofstream fout;
...
void ColorShader::ShutdownShader(OpenGLRenderer* OpenGL)
{
...
bool ColorShader::setShaderParameters(OpenGLRenderer* OpenGL, float* worldMatrix, float* viewMatrix, float* projectionMatrix)
{
