...
bool OpenGLRenderer::InitExtensions(HWND hwnd)
{
	HDC deviceContext;
...
bool OpenGLRenderer::InitOpenGL(HWND hwnd, int screenWidth, int screenHeight, float screenDepth, float screenNear, bool vsync)
{
...
void OpenGLRenderer::Shutdown(HWND hwnd)
{
...
void OpenGLRenderer::BeginScene(float red, float green, float blue, float alpha)
{
...
void OpenGLRenderer::GetWorldMatrix(float* matrix)
{
...
void OpenGLRenderer::GetProjectionMatrix(float* matrix)
{
...
void OpenGLRenderer::GetVideoCardInfo(char* cardName)
{
	strcpy_s(cardName, 128, m_videoCardDescription);
	return;
}

void OpenGLRenderer::BuildIdentityMatrix(float* matrix)
{
	matrix[0] = 1.0f;
	matrix[1] = 0.0f;
	matrix[2] = 0.0f;
...
void OpenGLRenderer::BuildPerspectiveFovLHMatrix(float* matrix, float fieldOfView, float screenAspect, float screenNear, float screenDepth)
{
...
void OpenGLRenderer::MatrixRotationY(float* matrix, float angle)
{
	matrix[0] = cosf(angle);
	matrix[1] = 0.0f;
	matrix[2] = -sinf(angle);
...
void OpenGLRenderer::MatrixTranslation(float* matrix, float x, float y, float z)
{
	matrix[0] = 1.0f;
	matrix[1] = 0.0f;
	matrix[2] = 0.0f;
...
void OpenGLRenderer::MatrixMultiply(float* result, float* matrix1, float* matrix2)
{
